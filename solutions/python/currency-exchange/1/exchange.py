...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # 2. Calculate the total un-rounded value in the new currency
    total_new_currency = budget / actual_rate
    
    # 3. Factor in the denomination (only whole bills allowed)
    # Floor divide by denomination to get the number of bills, 
    # then multiply back to get the total exchangeable value.
    max_value = (total_new_currency // denomination) * denomination
